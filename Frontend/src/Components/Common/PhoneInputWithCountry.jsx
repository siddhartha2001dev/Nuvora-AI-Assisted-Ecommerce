  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      <div className="flex items-center rounded-xl bg-neutral-900 border border-neutral-800 focus-within:border-white transition-colors overflow-hidden">
        ...
        >
          <span className="text-base leading-none country-flag no-invert inline-block select-none" data-flag>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center space-x-2.5 min-w-0 pr-2">
                      <span className="text-base shrink-0 country-flag no-invert inline-block select-none" data-flag>
                        {c.flag}
                      </span>
