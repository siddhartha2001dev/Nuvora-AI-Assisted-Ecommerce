...
import HeroFabricBackground from "../../Components/Home/HeroFabricBackground";
...
const Home = () => {
  ...
  }, [dispatch, page, selectedCategory, searchQuery, sortBy, priceRange]);
  ...
  // Toggle category or switch to All
  ...
  return (
    <div className="relative w-full max-w-full space-y-6 sm:space-y-12 pt-3 sm:pt-0 pb-16 sm:pb-24 overflow-x-hidden">
      ...
      <section className="hidden md:block relative px-4 sm:px-6 lg:px-8 py-14 sm:py-20 text-center border-b border-neutral-800/80 bg-[radial-gradient(#ffffff0a_1px,transparent_1px)] [background-size:24px_24px] overflow-hidden">
        {/* Monochromatic Dots Fabric Wave Animation Component */}
        <HeroFabricBackground />

        {/* Ambient Radial Glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] h-[350px] bg-white/[0.04] rounded-full blur-[100px] pointer-events-none z-0" />

        <div className="max-w-3xl mx-auto space-y-4 sm:space-y-6 relative z-10">
          <div className="inline-flex items-center space-x-2 px-3 py-1 sm:px-4 sm:py-1.5 rounded-full bg-[#121215]/90 backdrop-blur-md border border-neutral-800 text-[10px] sm:text-xs font-mono uppercase tracking-widest text-neutral-300 shadow-sm">
      ...
      {/* Mobile-Only Search, Sort & Filter Bar */}
      <section className="lg:hidden w-full max-w-7xl mx-auto px-4 sm:px-6 space-y-3">
        ...
        <div className="flex items-center justify-between gap-2.5">
          ...
          <button
            ...
            className={`flex items-center space-x-1.5 px-3.5 py-2.5 rounded-xl border text-[11px] font-semibold transition-all shrink-0 ${showMobileFilter || priceRange < 25000
        ...
        <div
          className={`overflow-hidden transition-all duration-300 ease-in-out ${showMobileFilter ? "max-h-96 opacity-100 pt-2" : "max-h-0 opacity-0 pointer-events-none"
            }`}
        >
        ...
        <div className="flex items-center justify-between">
          ...
          {selectedCategory !== "All" && (
            <button
              ...
              className="inline-flex items-center space-x-1.5 px-3 sm:px-4 py-1.5 rounded-full bg-white text-black text-xs font-bold shadow-md hover:bg-neutral-200 transition-all active:scale-95"
            >
              <span>{selectedCategory}</span>
              <HiOutlineX className="text-xs" />
              <span className="hidden sm:inline text-[10px] text-neutral-600 font-mono font-normal">
                (View All)
              </span>
            </button>
          )}
          ...
          {CATEGORY_CARDS.map((cat) => {
            ...
            return (
              <div
                ...
                className={`group relative p-6 rounded-3xl border cursor-pointer transition-all duration-300 flex flex-col justify-between space-y-4 ${isSelected
              ...
              >
                <div className="flex items-center justify-between">
                  <div
                    className={`p-3 rounded-2xl border transition-colors ${isSelected
                    ...
                    {[...Array(totalPages)].map((_, i) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-9 h-9 rounded-xl font-bold transition-all ${isActive
